  ...
  return (
    <div>
      ...
      <Modal show={show} onHide={handleClose}>
        ...
        <Form.Control type="text" placeholder='Enter movie title' value={title} onChange={(e) => handleTitle(e)}/>
        ...
        <Form.Control type="email" placeholder='Enter url' value={posterUrl} onChange={(e) => handlePosterUrl(e)}/>
